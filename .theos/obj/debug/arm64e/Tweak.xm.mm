...
static void (*_logos_orig$_ungrouped$SBWallpaperEffectView$layoutSubviews)(_LOGOS_SELF_TYPE_NORMAL SBWallpaperEffectView* _LOGOS_SELF_CONST, SEL); static void _logos_method$_ungrouped$SBWallpaperEffectView$layoutSubviews(_LOGOS_SELF_TYPE_NORMAL SBWallpaperEffectView* _LOGOS_SELF_CONST, SEL); static void (*_logos_orig$_ungrouped$SBRemoteAlertAdapter$viewDidAppear$)(_LOGOS_SELF_TYPE_NORMAL SBRemoteAlertAdapter* _LOGOS_SELF_CONST, SEL, BOOL); static void _logos_method$_ungrouped$SBRemoteAlertAdapter$viewDidAppear$(_LOGOS_SELF_TYPE_NORMAL SBRemoteAlertAdapter* _LOGOS_SELF_CONST, SEL, BOOL); 
...
static void _logos_method$_ungrouped$SBRemoteAlertAdapter$viewDidAppear$(_LOGOS_SELF_TYPE_NORMAL SBRemoteAlertAdapter* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, BOOL arg1) {
    _logos_orig$_ungrouped$SBRemoteAlertAdapter$viewDidAppear$(self, _cmd, arg1);
...
{Class _logos_class$_ungrouped$SBWallpaperEffectView = objc_getClass("SBWallpaperEffectView"); MSHookMessageEx(_logos_class$_ungrouped$SBWallpaperEffectView, @selector(layoutSubviews), (IMP)&_logos_method$_ungrouped$SBWallpaperEffectView$layoutSubviews, (IMP*)&_logos_orig$_ungrouped$SBWallpaperEffectView$layoutSubviews);Class _logos_class$_ungrouped$SBRemoteAlertAdapter = objc_getClass("SBRemoteAlertAdapter"); MSHookMessageEx(_logos_class$_ungrouped$SBRemoteAlertAdapter, @selector(viewDidAppear:), (IMP)&_logos_method$_ungrouped$SBRemoteAlertAdapter$viewDidAppear$, (IMP*)&_logos_orig$_ungrouped$SBRemoteAlertAdapter$viewDidAppear$);} }
#line 40 "Tweak.xm"
